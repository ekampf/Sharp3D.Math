...
namespace Sharp3D.Math.Core
{
	...
	public struct Matrix4D : ISerializable, ICloneable
	{
		...
		public static void Add(Matrix4D a, Matrix4D b, Matrix4D result)
		{
		...
		/// <param name="s">A scalar.</param>
		/// <param name="result">A <see cref="Matrix4D"/> instance to hold the result.</param>
		public static void Add(Matrix4D a, double s, Matrix4D result)
		{
			result.M11 = a.M11 + s;
			result.M12 = a.M12 + s;
			result.M13 = a.M13 + s;
		...
		/// <param name="b">A <see cref="Matrix4D"/> instance.</param>
		/// <param name="result">A <see cref="Matrix4D"/> instance to hold the result.</param>
		public static void Subtract(Matrix4D a, Matrix4D b, Matrix4D result)
		{
			result.M11 = a.M11 - b.M11;
			result.M12 = a.M12 - b.M12;
			result.M13 = a.M13 - b.M13;
		...
		/// <param name="s">A scalar.</param>
		/// <param name="result">A <see cref="Matrix4D"/> instance to hold the result.</param>
		public static void Subtract(Matrix4D a, double s, Matrix4D result)
		{
			result.M11 = a.M11 - s;
			result.M12 = a.M12 - s;
			result.M13 = a.M13 - s;
		...
		/// <param name="b">A <see cref="Matrix4D"/> instance.</param>
		/// <param name="result">A <see cref="Matrix4D"/> instance to hold the result.</param>
		public static void Multiply(Matrix4D a, Matrix4D b, Matrix4D result)
		{
		...
		public static void Transform(Matrix4D matrix, Vector4D vector, Vector4D result)
		{
