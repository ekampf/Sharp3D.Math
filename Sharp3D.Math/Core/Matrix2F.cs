...
namespace Sharp3D.Math.Core
{
    ...
    public struct Matrix2F : ISerializable, ICloneable
    {
        ...
        public static void Add(Matrix2F a, Matrix2F b, Matrix2F result)
        {
        ...
        /// <param name="s">A scalar.</param>
        /// <param name="result">A <see cref="Matrix2F"/> instance to hold the result.</param>
        public static void Add(Matrix2F a, float s, Matrix2F result)
        {
            result.M11 = a.M11 + s;
            result.M12 = a.M12 + s;
        ...
        /// <param name="b">A <see cref="Matrix2F"/> instance.</param>
        /// <param name="result">A <see cref="Matrix2F"/> instance to hold the result.</param>
        public static void Subtract(Matrix2F a, Matrix2F b, Matrix2F result)
        {
            result.M11 = a.M11 - b.M11;
            result.M12 = a.M12 - b.M12;
        ...
        /// <param name="s">A scalar.</param>
        /// <param name="result">A <see cref="Matrix2F"/> instance to hold the result.</param>
        public static void Subtract(Matrix2F a, float s, Matrix2F result)
        {
            result.M11 = a.M11 - s;
            result.M12 = a.M12 - s;
        ...
        /// <param name="b">A <see cref="Matrix2F"/> instance.</param>
        /// <param name="result">A <see cref="Matrix2F"/> instance to hold the result.</param>
        public static void Multiply(Matrix2F a, Matrix2F b, Matrix2F result)
        {
        ...
        public static void Transform(Matrix2F matrix, Vector2F vector, Vector2F result)
        {
