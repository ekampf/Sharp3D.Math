...
namespace Sharp3D.Math.Core
{
    ...
    public struct Matrix3D : ISerializable, ICloneable
    {
        ...
        public static void Add(Matrix3D a, Matrix3D b, Matrix3D result)
        {
        ...
        /// <param name="s">A scalar.</param>
        /// <param name="result">A <see cref="Matrix3D"/> instance to hold the result.</param>
        public static void Add(Matrix3D a, double s, Matrix3D result)
        {
            result.M11 = a.M11 + s;
            result.M12 = a.M12 + s;
            result.M13 = a.M13 + s;
        ...
        /// <param name="b">A <see cref="Matrix3D"/> instance.</param>
        /// <param name="result">A <see cref="Matrix3D"/> instance to hold the result.</param>
        public static void Subtract(Matrix3D a, Matrix3D b, Matrix3D result)
        {
            result.M11 = a.M11 - b.M11;
            result.M12 = a.M12 - b.M12;
            result.M13 = a.M13 - b.M13;
        ...
        /// <param name="s">A scalar.</param>
        /// <param name="result">A <see cref="Matrix3D"/> instance to hold the result.</param>
        public static void Subtract(Matrix3D a, double s, Matrix3D result)
        {
            result.M11 = a.M11 - s;
            result.M12 = a.M12 - s;
            result.M13 = a.M13 - s;
        ...
        /// <param name="b">A <see cref="Matrix3D"/> instance.</param>
        /// <param name="result">A <see cref="Matrix3D"/> instance to hold the result.</param>
        public static void Multiply(Matrix3D a, Matrix3D b, Matrix3D result)
        {
        ...
        public static void Transform(Matrix3D matrix, Vector3D vector, Vector3D result)
        {
